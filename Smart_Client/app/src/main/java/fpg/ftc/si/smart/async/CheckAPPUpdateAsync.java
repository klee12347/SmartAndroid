 ...
 */
public class CheckAPPUpdateAsync extends AsyncTask<String, Void, DownloadStatus> {

    private static final String TAG = makeLogTag(CheckAPPUpdateAsync.class);
    private DepartViewActivity mContext;
    private ProgressDialogFragment mDialog;
    private String mErrorMessage = "";
    public CheckAPPUpdateAsync(FragmentActivity mContext) {
