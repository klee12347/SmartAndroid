 ...
 */
public class FpgEditTextPreference extends EditTextPreference {
    public FpgEditTextPreference(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public FpgEditTextPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FpgEditTextPreference(Context context) {
        super(context);
    }
